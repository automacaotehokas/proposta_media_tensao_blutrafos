...
# Reutilizando as funções base dos formatadores existentes
...
def apply_cell_formatting(cell, font_name='Calibri Light (Títulos)', font_size=11, 
                        bold=False, alignment='center', color=None):
