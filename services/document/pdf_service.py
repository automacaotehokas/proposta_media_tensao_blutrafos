...
class PDFDocumentService:
    ...
    def gerar_pdf(dados_iniciais: Dict, impostos: Dict, itens_configurados: List[Dict]) -> BytesIO:
        ...
        elements.extend(PDFDocumentService._criar_cabecalho(dados_iniciais, styles))
        elements.extend(PDFDocumentService._criar_secao_variaveis(impostos, itens_configurados, styles))
        elements.extend(PDFDocumentService._criar_tabela_itens(itens_configurados, styles))
